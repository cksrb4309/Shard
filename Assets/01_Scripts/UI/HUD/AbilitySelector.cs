...
public class AbilitySelector : MonoBehaviour
{
    ...
    public Ability[] tier_1_Ability;
    public Ability[] tier_2_Ability;
    public Ability[] tier_3_Ability;

    public Color[] tierColors;
    public string[] tierShowNames;
    ...
    void ShowSelectAbilityApply()
    {
        ...
        for (int i = 0; i < selectGroups.Length; i++)
        {
            ...
            if (randomValue > 0.95f) ability = tier_3_Ability[Random.Range(0, tier_3_Ability.Length)];
            else if (randomValue > 0.65f) ability = tier_2_Ability[Random.Range(0, tier_2_Ability.Length)];
            else ability = tier_1_Ability[Random.Range(0, tier_1_Ability.Length)];
            ...
            selectGroups[i].abilityTierText.text = tierShowNames[ability.tier-1];
            selectGroups[i].abilityTierText.color = tierColors[ability.tier - 1];
        }
        selectedItems.Clear();
...
public class SelectGroup
{
    ...
    public TMP_Text abilityTierText;
}